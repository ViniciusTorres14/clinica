  ...
  return (
    <SafeAreaView style={styles.container}>
      <ScrollView contentContainerStyle={styles.scrollContent}>
        ...
        <Image
          source={require('../assets/images/fred.png')}
          style={styles.profileImage}
        />
        
        <View style={styles.infoSection}>
          <Text style={styles.sectionTitle}>Informações pessoais</Text>
          <Text style={styles.name}>Vinicius Ferreira Torres</Text>
          <Text style={styles.details}>11/08/2006</Text>
          <Text style={styles.details}>Lençóis Paulista-SP</Text>
        </View>
        
        <View style={styles.infoSection}>
          <Text style={styles.sectionTitle}>Histórico médico</Text>
          <View style={styles.medicalList}>
            <Text style={styles.medicalItem}>• lesão Virilha</Text>
            <Text style={styles.medicalItem}>• Dedo Quebrado</Text>
          </View>
        </View>
